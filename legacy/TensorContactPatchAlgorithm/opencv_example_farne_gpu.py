...
time_ms, count, depth_image, previous_frame, pcd, t2cam_pcd_cuda, vertex_map_np, normal_map_np = rsManager.get_frames()
timers = {}
device = "gpu"
...
if device == "cpu":
    ...
    while True:
        ...
        #count, depth_image, frame, t2cam_pcd, t2cam_pcd_cuda, vertex_map_np, normal_map_np = imageStream.get_next_frame()
